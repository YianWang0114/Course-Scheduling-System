...
# installed.
TK_PREFIX='/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/include'
...
# compiled.
TK_SRC_DIR='/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/projects/assigned/course-scheduling/Course-Scheduling-System/tmp/env/lib/libtkstub8.6.a'
